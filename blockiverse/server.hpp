...
inline void serverRoot::dmc_LoginClient(value_queue &vqueue) {
...
inline void serverRoot::dmc_AnswerChallenge(value_queue &vqueue) {
    /*
...
inline void serverRoot::dmc_GetAccount(value_queue &vqueue) {
    /*
